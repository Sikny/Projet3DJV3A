...
namespace Items.Consumables {
    [CreateAssetMenu(fileName = "MagicHealPotion", menuName = "ScriptableObject/Consumables/MagicHealthPotion")] 
    public class MagicHealthPotion : Consumable  //hérite de consommable ou équipement dépendant du type 
    {
